    ...
    , configured_(false)
{
    ...
    nh_private_.param<std::string>("imu_topic", imu_topic_, "/sensor/imu/data");
    ...
    imu_marker_pub_ = nh_.advertise<visualization_msgs::Marker>("sensor/imu/marker", 100);
    ...
    imu_sensor_data_pub_ = nh_.advertise<yesense_imu::YesenseImuSensorData>("sensor/imu/data_raw", 100);
